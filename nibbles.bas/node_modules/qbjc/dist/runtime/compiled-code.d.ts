...
export declare type CompiledStmt = CompiledLabelStmt | CompiledCodeStmt | CompiledDataStmt;
...
export declare type ExecutionDirective = GotoDirective | GosubDirective | ReturnDirective | EndDirective | ExitProcDirective;
export declare enum ExecutionDirectiveType {
    GOTO = "goto",
    GOSUB = "gosub",
    RETURN = "return",
    END = "end",
...
export declare type VarContainer = {
    [name: string]: any;
};
 ...
 */
export declare type Ptr<T = any> = [T, keyof T];
/** Arguments to a procedure. */
export declare type ArgsContainer = {
    [name: string]: Ptr;
};
...
export interface ExecutionContext {
    ...
    executeProc: (prevCtx: ExecutionContext, name: string, ...args: Array<Ptr>) => Promise<any>;
    /** Runtime implementation of READ. */
    read: (...resultTypes: Array<DataTypeSpec>) => Promise<Array<string | number>>;
...
export declare enum PrintArgType {
    COMMA = "comma",
    SEMICOLON = "semicolon",
    VALUE = "value"
}
/** Argument to print(). */
export declare type PrintArg = {
