...
import { DataTypeSpec, ElementaryTypeSpec, ProcDefType, ProcType, UdtTypeSpec } from './types';
/** An AST node. */
export declare type AstNode = Proc | Stmt | Expr;
...
export declare type Proc = SubProc | FnProc | DefFnProc;
...
export declare function isFnProcOrDefFnProc(proc: Proc): proc is FnProc | DefFnProc;
...
export declare type Stmts = Array<Stmt>;
/** A statement. */
export declare type Stmt = LabelStmt | DimStmt | AssignStmt | ConstStmt | GotoStmt | IfStmt | SelectStmt | CondLoopStmt | UncondLoopStmt | ExitLoopStmt | ForStmt | NextStmt | ExitForStmt | GosubStmt | ReturnStmt | CallStmt | ExitProcStmt | EndStmt | SwapStmt | PrintStmt | InputStmt | DefTypeStmt | DataStmt | ReadStmt | RestoreStmt;
...
export declare type SingularTypeExpr = ElementaryTypeExpr | UdtTypeExpr;
export declare type DataTypeExpr = SingularTypeExpr | ArrayTypeExpr;
export declare enum DataTypeExprType {
    ELEMENTARY = "elementary",
    ARRAY = "array",
    UDT = "udt"
}
export declare function isSingularTypeExpr(typeExpr: DataTypeExpr): typeExpr is SingularTypeExpr;
...
export declare type CaseExpr = ValueCaseExpr | RangeCaseExpr | CompCaseExpr;
export declare enum CaseExprType {
...
export declare enum CondLoopStructure {
...
export declare enum PrintSep {
    COMMA = "comma",
    SEMICOLON = "semicolon"
}
export declare type PrintArg = Expr | PrintSep;
...
/** An expression. */
export declare type Expr = LiteralExpr | VarRefExpr | FnCallExpr | BinaryOpExpr | UnaryOpExpr | SubscriptExpr | MemberExpr;
/** An expression that can be assigned to. */
export declare type LhsExpr = VarRefExpr | SubscriptExpr | MemberExpr;
export declare function isLhsExpr(expr: Expr): expr is LhsExpr;
...
export declare class AstVisitorError<T extends AstNodeBase> extends ErrorWithLoc {
    constructor(message: string, { sourceFileName, node }?: {
        sourceFileName?: string;
        node?: T;
    });
}
/** Base class for AST visitors. */
export declare abstract class AstVisitor<T = any> {
